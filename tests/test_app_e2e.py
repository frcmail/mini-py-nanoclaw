...
def test_recover_pending_messages_uses_existence_probe(monkeypatch) -> None:
    db = NanoClawDB.in_memory()
    ...
    def fake_has_messages_since(chat_jid: str, since: str, bot_prefix: str) -> bool:
    ...
    queued: list[str] = []
    monkeypatch.setattr(app.db, "has_messages_since", fake_has_messages_since)
